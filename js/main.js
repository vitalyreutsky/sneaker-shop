...
/* harmony import */ var _components_show_filter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/show-filter */ "./src/js/components/show-filter.js");
/* harmony import */ var _components_show_filter__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_components_show_filter__WEBPACK_IMPORTED_MODULE_8__);
...
var prodSlider = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".modal-slider__container", {
  slidesPerView: 1,
  spaceBetween: 20
});
  ...
  var loadProducts = function loadProducts() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default().get("https://vitalyreutsky.github.io/json-for-sneaker-shop/data.json").then(function (response) {
      ...
      productTitle.forEach(function (el) {
        clamp_js__WEBPACK_IMPORTED_MODULE_0___default()(el, {
          clamp: "22px"
        });
      });
      var productsBtns = document.querySelectorAll(".product__btn");
      productsBtns.forEach(function (btn) {
    ...
    value: function nextQuestion() {
      if (this.valid()) {
        if (this.counter + 1 < this.dataLength) {
          ...
          if (this.counter + 1 == this.dataLength) {
            document.querySelector(".quiz-question-answers").style.display = "block";
          }
        } else {
          ...
          document.querySelector(".quiz__descr").textContent = "Оставьте свои контактные данные, чтобы мы могли отправить подготовленный для вас каталог";
        }
      } else {
...
/***/ "./src/js/components/show-filter.js":
/*!******************************************!*\
  !*** ./src/js/components/show-filter.js ***!
  \******************************************/
/***/ (() => {

var showFilterBtn = document.querySelector(".catalog-filter");
var filter = document.querySelector(".catalog__left");
...
if (menuLinks.length > 0) {
  ...
  function onMenuLinkClick(e) {
    ...
    if (menuLink.dataset.goto && document.querySelector(menuLink.dataset.goto)) {
      ...
      var goToBlockValue = goToBlock.getBoundingClientRect().top + pageYOffset - document.querySelector(".header").offsetHeight - 0;
      window.scrollTo({
        top: goToBlockValue,
        behavior: "smooth"
      });
